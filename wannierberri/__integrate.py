...
calculators_trans={ 
         ...
         'berry_dipole_field'              : fermiocean.berry_dipole_field            ,
         'berry_dipole_test'               : fermiocean.berry_dipole_test             ,
         'berry_dipole_fsurf'              : fermiocean.berry_dipole_fsurf            ,
         'berry_dipole_field_fsurf'        : fermiocean.berry_dipole_field_fsurf      ,
         ...
         'Drude'                           : fermiocean.Drude                         ,
         'Drude_fsurf'                     : fermiocean.Drude_fsurf                   ,
         'Drude_fder2'                     : fermiocean.Drude_fder2                   ,
