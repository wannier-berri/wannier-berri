...
def Omega_tot(data_K,Efermi,kpart=None):
    return iterate_kpart(trF.Omega,data_K,Efermi,kpart)

def LFAHE_spin_fsea(data_K, Efermi, Bdirection=None,kpart=None):
    factor = hbar / (2 * electron_mass) * fac_ahc
    return iterate_kpart(trF.pertOmegaZeemanSpin,data_K,Efermi,kpart,Bdirection=Bdirection)*factor
