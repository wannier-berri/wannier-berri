...
class System_PythTB(System):
    ...
    def __init__(self,ptb_model=None,getAA=False,
        ...
        uniques=np.column_stack((Rvecs.T,np.array([0,0,0]))).T
        ...
        for nhop in ptb_model._hoppings:
            ...
            self.HH_R[i,j,indexneg]+=np.conjugate(nhop[0])
        ...
        cprint ("Reading the system from PythTB model finished successfully",'green', attrs=['bold'])
