...
class EBRsearcher:
    ...
    * So far it does not work with time-reversal symmetry, and was not tested with spinor wavefuncitons.
    ...
    def __init__(self,
        ...
        self.set_dft_irreps(symmetrizer, froz_min=froz_min, froz_max=froz_max, outer_min=outer_min, outer_max=outer_max, degen_thresh=degen_thresh)
    ...
    def set_trial_projections_irreps(self, symmetrizer, trial_projections_set):
        ...
        if self.debug:
            highlight("detecting irreps generated by each projections")
        ...
        for projection in trial_projections_loc:
            ...
            for orb in projection.orbitals:
                dwann = Dwann(spacegroup=symmetrizer.spacegroup,
                            positions=positions,
                            orbital=orb,
    ...
    def set_dft_irreps(self, symmetrizer,
