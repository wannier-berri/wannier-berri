...
class DMN(W90_file):
    ...
    def from_irrep(self, bandstructure: BandStructure,
        ...
        """
        self.grid, self.kpoints, self.kptirr, self.kptirr2kpt, self.kpt2kptirr, \
            self.d_band_blocks, self.d_band_block_indices = \
                bandstructure.get_dmn(grid=grid, degen_thresh=degen_thresh)
