...
def tbmodels_Haldane():
    return wb_models.Haldane_tbm(delta=0.2,t=-1.0,hop2 =0.15)
...
@pytest.fixture(scope="session")
def pythtb_Haldane():
    return wb_models.Haldane_ptb(delta=0.2,t=-1.0,hop2 =0.15)
...
@pytest.fixture(scope="session")
def ChiralModel():
    return wb_models.Chiral(delta=2, t=1, hop2=1./3,  phi=np.pi/10, hopz=0.2)
