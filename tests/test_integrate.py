...
from create_system import system_Fe_W90,system_Fe_W90_wcc,system_GaAs_W90,system_GaAs_W90_wcc,system_GaAs_tb,system_GaAs_tb_wcc,system_GaAs_tb_wcc_ws
...
def test_GaAs_tb_wcc_ws(check_integrate,system_GaAs_tb_wcc_ws, compare_energyresult,quantities_GaAs_internal,Efermi_GaAs):
