...
def test_GaAs_sym_tb(check_integrate, system_GaAs_sym_tb, compare_energyresult):
    ...
    check_integrate(system_GaAs_sym_tb , ["ahc"], fout_name="ahc_GaAs_tb" , suffix="sym" , Efermi=Efermi_GaAs , comparer=compare_energyresult,compare_zero=True,extra_precision = {"ahc":1e-6})
