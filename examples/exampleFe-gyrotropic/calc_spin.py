...
def main():
    ...
    Efermi=np.linspace(10.,15.,10001)
#    Data=get_data.Data(tb_file='Fe_tb.dat',getAA=True)
    Data=get_data.Data(seedname,getAA=True,getSS=True)
    generators=[SYM.Inversion,SYM.C4z,SYM.TimeReversal*SYM.C2x]
    t1=time()
    eval_func=functools.partial(  spin.calcSpinTot, Efermi=Efermi, smoother=smoother(Efermi,10) )
