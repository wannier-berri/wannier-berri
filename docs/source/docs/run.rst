...
and also same quantities may be calculated with different sets of parameters in one run.
...
Sometimes, it is needed to evaluate some properties at a single k-point. To make it simple a function is provided:
